...
<div class="product-col simpleCart_shelfItem">
    <div class="img">
        <a href="<?= Url::to(['product/view', 'id' => $model->id,'category_id' => $model->category_id]);?>">
            <img
                src="/uploads/<?= $model->image ?>" class="img-item img-responsive" alt="Oatey 316-in x 5-ft Rubber Utility Hose"
                title=" Oatey 316-in x 5-ft Rubber Utility Hose " width="200" height="200"></a></div>
    <div class="prod-info"><h5 itemprop="name">
            <?= Html::a(Html::encode($model->code), ['view', 'id' => $model->id, 'category_id' => $model->category_id],['class' => 'product-name item_name name']);?>
        </h5>
