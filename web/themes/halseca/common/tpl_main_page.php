    ...
    <div class="copyright">
      <div class="container">
        <div class="row">
          <div class="col-xs-12">
            <!-- ========== COPYRIGHT ========== -->
                <p><?php echo FOOTER_TEXT_BODY; ?> &nbsp;| &nbsp;<a href="<?php echo zen_href_link(FILENAME_PRIVACY)?>"><?php echo BOX_INFORMATION_PRIVACY?></a> &nbsp;| &nbsp;<a href="<?php echo zen_href_link(FILENAME_PAGE_2)?>">Template settings</a>
                <?php
                    if (SHOW_FOOTER_IP == '1') {
                ?>
